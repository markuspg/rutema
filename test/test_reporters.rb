...
module TestRutema
  ...
  class TestBlockReporter < Test::Unit::TestCase
    ##
    # Test Rutema::Reporters::BlockReporter initialization
    def test_initialize
    ...
    ##
    # Test Rutema::Reporters::BlockReporter#report
    def test_report
  ...
  class TestConsole < Test::Unit::TestCase
    ##
    # Test Rutema::Reporters::Console initialization
    def test_initialize
  ...
  class TestEventReporter < Test::Unit::TestCase
    ##
    # Test Rutema::Reporters::EventReporter initialization
    def test_initialize
      dispatcher = mock
      dispatcher.expects(:subscribe).once.returns(Queue.new).with \
        { |value| value.is_a?(Integer) }
    ...
    ##
    # Test the threading functionality of Rutema::Reporters::EventReporter
    def test_threading
      dispatcher = mock
    ...
    ##
    # Test Rutema::Reporters::EventReporter#update
    def test_update
      dispatcher = mock
      dispatcher.expects(:subscribe).once.returns(Queue.new).with \
        { |value| value.is_a?(Integer) }
