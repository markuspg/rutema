...
module TestRutema
  ...
  class TestConfigurationDirectives < Test::Unit::TestCase
    ##
    # Test Rutema::ConfigurationDirectives#init
    def test_init
    ...
    ##
    # Test Rutema::ConfigurationDirectives#context=
    def test_context
      test_instance = InitTestClass.new
    ...
    ##
    # Test Rutema::ConfigurationDirectives#parser=
    def test_parser
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
    ...
    ##
    # Test Rutema::ConfigurationDirectives#path=
    def test_path
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
    ...
    ##
    # Test Rutema::ConfigurationDirectives#reporter=
    def test_reporter
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
    ...
    ##
    # Test Rutema::ConfigurationDirectives#runner=
    def test_runner
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
    ...
    ##
    # Test Rutema::ConfigurationDirectives#setup=
    def test_setup
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
    ...
    ##
    # Test Rutema::ConfigurationDirectives#suite_setup=
    ...
    ##
    # Test Rutema::ConfigurationDirectives#suite_teardown=
    ...
    ##
    # Test Rutema::ConfigurationDirectives#teardown=
    def test_teardown
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
    ...
    ##
    # Test Rutema::ConfigurationDirectives#tests=
    def test_tests
      test_instance = InitTestClass.new
    ...
    ##
    # Test Rutema::ConfigurationDirectives#tool=
    def test_tools
      test_instance = InitTestClass.new
      assert_raise(Rutema::ConfigurationException) do
  ...
  class TestRutemaConfiguration < Test::Unit::TestCase
    ##
    # Test Rutema::Configuration#configure
    ...
    ##
    # Test Rutema::Configuration#import
    ...
    ##
    # Test Rutema::Configuration initialization
    ...
    ##
    # Test Rutema::Configuration specification path handling
