...
module TestRutema
  ...
  class TestXMLParser<Test::Unit::TestCase
    ##
    # Test Rutema::Parsers::XML#parse_specification
    ...
    ##
    # Test Rutema::Parsers::XML#parse_specification handling specifications with
    # an +include_scenario+ element
    def test_include
      config=stub()
      config.stubs(:parser).returns({})
      parser=Rutema::Parsers::XML.new(config)
    ...
    ##
    # Test Rutema::Parsers::XML#parse_specification handling an invalid
    # specification
