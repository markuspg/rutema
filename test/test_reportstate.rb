...
module TestRutema
  ##
  # Test Rutema::ReportState
  class TestReportState < Test::Unit::TestCase
    ##
    # Test Rutema::ReportState initialization
    def test_initialize
      # Prepare mock
      mock_message = mock
      ...
      assert_nothing_raised do
        report_state = Rutema::ReportState.new(mock_message)
      end
    ...
    # Test Rutema::ReportState#<<
    def test_insertion
      # Prepare mock and create ReportState instance
      mock_message_a = mock
      ...
      report_state = Rutema::ReportState.new(mock_message_a)

      # Test insertion
      mock_message_b = mock
      mock_message_b.expects(:duration).returns(29)
      mock_message_b.expects(:status).times(3).returns(:success)
      ...
      mock_message_c.expects(:status).times(3).returns(:error)
      ...
      mock_message_d.expects(:status).twice.returns(:warning)
