...
module Rutema
  ...
  #
  # It instantiates the configured Rutema::Parsers and Rutema::Runners instances
  # and wires these together via Rutema::Dispatcher (which itself creates and
  # holds the Rutema::Reporters instances).
  #
  ...
  class Engine
    ...
    # +configuration+
    #
    # This function creates a parser, a runner and a dispatcher which share a
