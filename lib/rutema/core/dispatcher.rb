...
module Rutema
  ##
  # Dispatcher functions as a demultiplexer between Engine and the various
  # reporters
  #
  ...
  #
  # By default this includes the Reporters::Collector reporter which is then
  # used at the end of a run to provide the collected data to all registered
  # block mode reporters.
  class Dispatcher
    ##
    # The interval between threaded queue operations
    INTERVAL = 0.01

    ##
    # Initialize a new Dispatcher with a given input +queue+ and +configuration+
    #
    # The +configuration+ is needed by and utilized for the Reporters instances
    ...
    #
    # The passed queue will have data pushed by the Dispatcher instance
    ...
    # streaming reporters
    #
    # As documented within #flush this method is potentially blocking.
    def exit
    ...
    #
    # This function blocks for queue_length times INTERVAL seconds.
    def flush
