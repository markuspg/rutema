...
module Rutema
  ...
  module ConfigurationDirectives
    ##
    # A Hash for passing data into Rutema runs
    attr_reader :context
    ##
    # A parser which shall be utilized for reading test specifications
    attr_reader :parser
    ##
    # Paths which can be added as additional information to Rutema runs
    attr_reader :paths
    ##
    # A Hash containing (multiple) reporter(s) which shall report a Rutema run
    attr_accessor :reporters
    ##
    # A runner which shall be utilized to execute test specifications
    attr_reader :runner
    ##
    # A setup specification to be run before each specification of a suite
    attr_reader :setup
    ##
    # A setup specification to be run before a test suite is started
    attr_reader :suite_setup
    ##
    # A teardown specification to be run after a test suite finished
    attr_reader :suite_teardown
    ##
    # A teardown specification to be run after each specification of a suite
    attr_reader :teardown
    ##
    # An Array of test specifications making up the configured suite
    attr_reader :tests
    ##
    # A Hash of tools which shall be accessible within the Rutema run
    attr_reader :tools
  ...
  class Configuration
    ...
    ##
    # An absolute or relative path to the filename this Configuration instance
    # was created with
