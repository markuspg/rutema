...
module Rutema
  ...
  ##
  # A Specification contains all elements required for running a test: the
  # scenario to run together with a textual description and information that
  # aids in tracing the test back to the requirements.
  class Specification
  ...
  ##
  # A Scenario is a sequence of Step instances.
  #
  # The Step instances are run in the defined sequence and the scenario is
  # successful if all steps are conducted successfully.
  #
  ...
  #
  # A failure in a step results in the interruption of execution and a report of
  # occurred errors.
  class Scenario
    include SpecificationElement

    ##
    # The Rutema::Step instances making up this scenario
    attr_accessor :steps
