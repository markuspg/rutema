...
module Rutema
  ...
  module Runners
    ...
    class Default < BaseRunner
      ...
      attr_reader :context
      ##
      # A specification to be run before any specification run with #run
      attr_accessor :setup
      ##
      # A specification to be run after any specification run with #run
      ...
      ##
      # Run a command associated with a step
